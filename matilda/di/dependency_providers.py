...
def thread_pool_provider(dependency_container: DependencyContainer) -> ThreadPoolExecutor:
    thread_pool_executor = ThreadPoolExecutor()
    dependency_container.get(DestructionManager).add_destructor(thread_pool_executor.shutdown)
...
def add_dependency_providers(dependency_container: DependencyContainer):
    ...
    dependency_container.add_provider(ThreadPoolExecutor, thread_pool_provider)
