...
class DynamicServiceConverter(ProtobufConverter[T]):
    def __init__(self, command_registry_manager: CommandRegistryManager,
                 command_registry_factory: CommandRegistryFactory[T],
    ...
    def to_protobuf(self, value: T) -> Int32Value:
        registry_id = self.__command_registry_manager.add_command_registry(
