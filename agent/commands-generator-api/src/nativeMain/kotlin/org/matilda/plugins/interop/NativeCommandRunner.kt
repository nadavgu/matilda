...
class NativeCommandRunner(
    private val mFunction: CPointer<CFunction<(COpaquePointer?, Int, Int, CValue<ByteArrayStruct>) -> CValue<ByteArrayStruct>>>,
    ...
    override fun run(registryId: Int, commandType: Int, parameter: ByteArray): ByteArray {
        return parameter.tempByteArrayStruct { parameterStruct ->
            mFunction(mInstance, registryId, commandType, parameterStruct).moveToByteArray()
        }
    }
}